// The noise is vector noise (not scalar noise as in original Vicsek model.
...
//====================================================================//
  ...
  static int flag,n,X,Y,XCL,XCR,XLL,XLR,XRL,XRR,YCB,YCT,YBB,YBT,YTB,YTT,eta;
  ...
  fprintf(fp1,"%lf	%lf\n",ETA,PHI);  //for writing inside the files
  fprintf(fp2,"%lf	%lf\n",ETA,BC);
  fprintf(fp3,"%lf	%lf\n",ETA,CHI);
